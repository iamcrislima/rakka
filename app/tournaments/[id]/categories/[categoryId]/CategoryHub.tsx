  ...
  return (
    <div className={`hidden lg:flex items-center justify-between rounded-2xl px-7 py-5 text-white overflow-hidden relative ${
      ...
      <div className="flex items-center gap-4">
        <Link href={`/tournaments/${tournament.id}`} className="text-white/50 hover:text-white/80 text-sm font-bold transition-colors shrink-0">
          ← {tournament.name}
        </Link>
  ...
  return (
    <div className={`lg:hidden relative rounded-2xl px-5 py-4 text-white overflow-hidden ${
      ...
      <div className="relative">
        <Link href={`/tournaments/${tournament.id}`} className="text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-white/60 transition-colors block mb-1">
          ← {tournament.name}
        </Link>
