    ...
    <div>
      ...
      <div className="relative bg-gradient-to-br from-[#1a0533] to-[#6D28D9] rounded-2xl px-5 py-5 text-white overflow-hidden mb-5">
        ...
        <div className="lg:hidden">
          <Link href="/leagues" className="text-[10px] font-black uppercase tracking-widest text-white/40">
            ← Ligas
          </Link>
        ...
        <div className="hidden lg:flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/leagues" className="text-white/50 hover:text-white/80 text-sm font-bold transition-colors shrink-0">
              ← Ligas
            </Link>
